const menuData = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        price: "$4.75",
        description: "Beef, Chicken, or Veggie patties",
        image: "./images/products/RiseUpMarketplace_JamaicanPatty2.jpg",
      },
      {
        title: "Daily Soup",
        price: "$6.50",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        title: "Coconut Water",
        price: "$2.50",
        description: "Grace coconut water",
        image: "",
      },
      {
        title: "Jarritos Mexican Soda",
        price: "$3",
        description:
          "Mexican soda in Cola, Lime, Pineapple, and Guava flavours",
        image: "",
      },
      {
        title: "A&W Root Beer",
